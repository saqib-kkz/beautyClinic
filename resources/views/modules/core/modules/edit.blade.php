...
@section('sub-title') Update @endsection
@section('page')
    <section class="section">
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="card-title">Update Current Module</h5>
                    <a href="{{route('core.module-list')}}"><< Back to list</a>
                </div>

                <form class="row g-3" method="post" action="{{route('core.module-update')}}">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="status" id="status" {{($data->status == 'Active') ? 'checked' : ''}}>
